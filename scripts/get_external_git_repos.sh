...
################################################################################
#
# Date/Beginn :    06.02.2017/15.08.2015
#
# Version     :    V3.00
#
# Milestones  :    V3.00 (feb 2018) -> takeover for my_eos_and_rtos_playground.git
#                                      cleanups/removes
...
# Description
#
#   A simple tool to get externel git repos like jailhouse ...
#
# Some features
#   - clone repo with all possible network protocols
#
# Notes
#   - ...
#
...
my_usage()
{
    ...
    echo "|                                                        |"
    echo "| Example:                                               |"
    echo "| get_external_git_repos.sh -r jailhouse -p http         |"
    echo "|                                                        |"
